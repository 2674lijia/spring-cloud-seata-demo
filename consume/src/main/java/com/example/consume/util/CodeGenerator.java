package com.example.consume.util;
...
public class CodeGenerator {
    ...
    //项目的真实路径
    private static final String PROJECT_RELATIVE_PATH = "F:\\work\\Project_ing\\demo\\consume";
    ...
    public static void main(String[] args) {
        ...
        pc.setParent("com.example.consume"); //设置父包
